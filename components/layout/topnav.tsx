        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-80 rounded-xl">
            <div className="flex items-center justify-between px-4 py-2 border-b">
              ...
              <button className="text-[10px] font-medium text-[#30539C] hover:underline">Mark all as read</button>
            </div>
            ...
            <div className="p-2 border-t">
              <button className="w-full text-xs text-[#30539C] font-medium hover:underline py-1">
